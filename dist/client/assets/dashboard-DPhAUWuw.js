import"./app-BHlbqWfx.js";const D=new URLSearchParams(window.location.search).get("merchantId")||"merchant_demo",H="/charge-with-crypto-mark.svg",I="charge-with-crypto.dashboard-token";let i=null,E=null,f="",d=[],u=null,$="overview",h=localStorage.getItem(I)||"",L=!1,p={search:"",status:"all",method:"all",range:"30d"};async function R(e,n){const t=new Headers(n?.headers||{});h&&t.set("x-dashboard-token",h);const a=await fetch(e,{...n,headers:t}),s=await a.json();if(!a.ok)throw new Error(s.error||s.message||`HTTP ${a.status}`);return s}function k(e,n=""){L=!!e,document.querySelectorAll("#merchantForm input, #merchantForm textarea, #merchantForm select, #merchantForm button").forEach(t=>{t.disabled=!L}),document.querySelectorAll("#checkoutForm input, #checkoutForm textarea, #checkoutForm select, #checkoutForm button").forEach(t=>{t.disabled=!L}),document.getElementById("dashboardAuthPanel").hidden=L||!i?.dashboardAuthConfigured,document.getElementById("dashboardAuthStatus").textContent=n}function V(e,n,t){return`<label class="checkbox-pill"><input type="checkbox" name="${e}" value="${n}" /> <span>${t}</span></label>`}function m(e,n="evm"){return e==="bitcoin"||n==="bitcoin"?"bitcoin":"evm"}function w(e){return e==="bitcoin"?"bitcoin":"evm"}function S(e){return e==="BTC"?"bitcoin":"evm"}function ce({paymentRail:e,enabledChains:n=[],acceptedAssets:t=[],fallback:a="evm"}={}){const s=e?m(e,a):"";if(s)return s;const c=[...new Set([...(n||[]).map(l=>w(l)),...(t||[]).map(l=>S(l))])];return c.length===1?c[0]:m(a,"evm")}function j(e){return m(e)==="bitcoin"?"Bitcoin":"EVM"}function g(e,n,t){const a=t==="chain"?w:S;return(e||[]).filter(s=>a(s)===n)}function U(e,n){if(n==="chain"){const s=Object.keys(i?.chains||{}).filter(c=>w(c)===e);return e==="bitcoin"?s.slice(0,1):s.includes("base")?["base"]:s.slice(0,1)}const t=Object.keys(i?.assets||{}).filter(s=>S(s)===e);if(e==="bitcoin")return t.includes("BTC")?["BTC"]:t.slice(0,1);const a=["USDC","USDT"].filter(s=>t.includes(s));return a.length?a:t.slice(0,1)}function y(e){return`$${Number(e||0).toFixed(2)}`}function z(e){return e?new Date(e).toLocaleString():"n/a"}function oe(e){return Date.now()-Number(e)*24*60*60*1e3}function o(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function le(e,n){const t={ethereum:"https://etherscan.io/tx/",base:"https://basescan.org/tx/",arbitrum:"https://arbiscan.io/tx/",polygon:"https://polygonscan.com/tx/"}[e];return t&&n?`${t}${n}`:""}function re(){return{id:`plan_${Math.random().toString(36).slice(2,8)}`,title:"New plan",description:"",amountUsd:10,paymentRail:"evm",enabledChains:["base"],acceptedAssets:["USDC","USDT"]}}function K(e){return e||H}function M(e){const n=document.getElementById("merchantLogoPreview");n.src=K(e),n.onerror=()=>{n.onerror=null,n.src=H}}function T(e,n){const t=new Set(n||[]);document.querySelectorAll(`#${e} input[type="checkbox"]`).forEach(a=>{a.checked=t.has(a.value)})}function B(e){return[...document.querySelectorAll(`#${e} input[type="checkbox"]:checked`)].map(n=>n.value)}function X(e,n,t,a=[]){const s=g(B(e),n,t),c=g(a,n,t),l=s.length?s:c;document.querySelectorAll(`#${e} .checkbox-pill`).forEach(r=>{const v=r.querySelector("input"),_=(t==="chain"?w(v.value):S(v.value))===n;r.hidden=!_,v.disabled=!_,_||(v.checked=!1)}),T(e,l)}function de(e){const n=document.getElementById("manualEngineStatus");if(!n)return;const t=e?.manualPayment||{configured:!1,sponsorAddress:"",derivationPath:""},a=!!t?.bitcoin?.configured;if(!t.configured){n.innerHTML=`
