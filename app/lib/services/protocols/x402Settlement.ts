...
class X402Settlement<Sale> {
	...
	routeConfig: (sale: Sale, resourcePath: string, extensions?: unknown) => unknown
	requireEnabledHandler: () => Promise<void>
	checkoutMatches: (checkout: CheckoutLike, sale: Sale) => boolean
	purchaseMatches: (checkout: CheckoutLike, sale: Sale, resourcePath: string) => boolean
	...
	unpaid: (sale: Sale, checkout?: CheckoutLike | null) => Record<string, unknown>
	success: (
		sale: Sale,
