...
const rawEnvSchema = z.object({
  ...
  BITCOIN_PAYMENT_XPUB: optionalTrimmed(),
  BITCOIN_PAYMENT_START_INDEX: integerDefault(0),
...
const config = {
  ...
  bitcoinPaymentXpub: parsedEnv.BITCOIN_PAYMENT_XPUB,
  bitcoinPaymentStartIndex: parsedEnv.BITCOIN_PAYMENT_START_INDEX,
